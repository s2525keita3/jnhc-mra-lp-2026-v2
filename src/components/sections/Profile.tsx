  ...
  return (
    <section className="py-20 bg-navy-50">
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="bg-white rounded-2xl shadow-card border-t-4 border-teal-500 overflow-hidden flex flex-col md:flex-row hover-lift animate-fade-up">
          ...
          <div className="md:w-2/3 p-8 md:p-12">
            <div className="hidden md:block mb-6">
              <p className="text-teal-600 font-bold tracking-wider text-sm">REPRESENTATIVE</p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8 pt-8 border-t border-teal-100">
              <div className="text-center">
                <div className="text-2xl font-bold text-navy-500">50<span className="text-sm font-normal">社+</span></div>
                <div className="text-xs text-text-tertiary">支援実績</div>
              </div>
              <div className="text-center border-l border-teal-100">
                <div className="text-2xl font-bold text-navy-500">11<span className="text-sm font-normal">万+</span></div>
                <div className="text-xs text-text-tertiary">SNSフォロワー</div>
              </div>
              <div className="text-center border-l border-teal-100">
                <div className="text-2xl font-bold text-navy-500">5<span className="text-sm font-normal">億</span></div>
                <div className="text-xs text-text-tertiary">年商規模</div>
              </div>
              <div className="text-center border-l border-teal-100">
                <div className="text-2xl font-bold text-navy-500">5<span className="text-sm font-normal">店舗</span></div>
