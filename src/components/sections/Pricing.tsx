    ...
    <section id="apply" className="gradient-bg relative">
      ...
      <div className="py-20">
        <div className="max-w-4xl mx-auto px-4">
          <div className="bg-white rounded-2xl shadow-card-hover overflow-hidden border-t-4 border-teal-500 relative hover-lift animate-fade-up">
            ...
            <div className="grid md:grid-cols-5 h-full">
              ...
              <div className="md:col-span-2 bg-teal-50 p-8 md:p-10 flex flex-col justify-center items-center border-t md:border-t-0 md:border-l border-teal-100">
                ...
                <div className="mt-6 text-[10px] text-text-tertiary text-center space-y-2">
                  ...
                  <div className="border-t border-teal-100 pt-2 mt-2 text-left leading-relaxed text-text-light">
                    <p>※ 毎月自動引き落とし</p>
