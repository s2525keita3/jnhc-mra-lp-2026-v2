...
export const StickyCta = () => {
  ...
  return (
    <div className={`fixed bottom-0 left-0 right-0 z-40 bg-white border-t-4 border-teal-500 shadow-[0_-5px_20px_rgba(0,0,0,0.1)] transition-transform duration-300 ${isVisible ? 'translate-y-0' : 'translate-y-full'}`}>
